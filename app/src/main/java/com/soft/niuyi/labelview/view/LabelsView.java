package com.soft.niuyi.labelview.view;
...
import com.soft.niuyi.labelview.R;
...
public class LabelsView extends ViewGroup {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mTextSize = mTypedArray.getDimension(R.styleable.LabelsView_labelTextSize, 42.0f);
            mTextPaddingLeft = mTypedArray.getDimensionPixelOffset(R.styleable.LabelsView_labelTextPaddingLeft, 0);
            mTextPaddingTop = mTypedArray.getDimensionPixelOffset(R.styleable.LabelsView_labelTextPaddingTop, 0);
            mTextPaddingRight = mTypedArray.getDimensionPixelOffset(R.styleable.LabelsView_labelTextPaddingRight, 0);
            mTextPaddingBottom = mTypedArray.getDimensionPixelOffset(R.styleable.LabelsView_labelTextPaddingBottom, 0);
            ...
            mLabelBgRes = mTypedArray.getResourceId(R.styleable.LabelsView_labelBackground, -1);
            mTypedArray.recycle();
        }
    }
